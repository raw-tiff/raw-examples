...
test \
 $(ls ../build/libs | grep raw-core-0.1.0.jar | wc -l) -eq 1 || \
 wget --output-document=../build/libs/raw-core-0.1.0.jar \
 https://dl.bintray.com/gasrios/maven/com/github/gasrios/raw/raw-core/0.1.0/raw-core-0.1.0.jar
...
java -cp ../build/libs/xmp-core-5.1.3-raw.jar:../build/libs/raw-core-0.1.0.jar:../build/libs/raw-0.1.0.jar:../build/libs/raw-examples.jar com.github.gasrios.raw.examples.ReadMetadata $1; echo "--"
