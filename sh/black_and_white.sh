...
java -cp ../build/libs/xmp-core-5.1.3-raw.jar:../build/libs/raw-core-0.1.0.jar:../build/libs/raw-0.1.0.jar:../build/libs/raw-examples.jar \
 com.github.gasrios.raw.CommandLineInvoker \
